...
public class TypedBlock extends GenericBlock {
    public Type type;

    public TypedBlock(String prefix, String name, Type type) {
        this(prefix, name, type.parent, type.toughness.getLeft(), type.toughness.getRight());
        this.type = type;
    }

    public TypedBlock(String prefix, String name, Block parent) {
        super(parent, prefix + name);
    }

    public TypedBlock(String prefix, String name, Block parent, float hardness, float resistance) {
        super(parent, prefix + name);
